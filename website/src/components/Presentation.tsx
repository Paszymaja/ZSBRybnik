    ...
    <PresentationWrapper>
      <PresentationBlock isDarkTheme={isDarkTheme} centered>
        <div>
          ...
          <PresentationContentFitImageBlock title="Złote technikum" src="/images/gold-medium-school.png" alt="Złote technikum" loading="lazy" width="200" height="200" />
        </div>
      </PresentationBlock>
        ...
        <div>
          ...
          <PresentationSection>
            ...
            <div className="presentation-section-img-block">
              <PresentationImageBlock src="/images/silesian-technical-university.png" alt="Politechnika Śląska" loading="lazy" width="50" height="50" />
              <div>Politechnika śląska</div>
            </div>
            <div className="presentation-section-img-block">
              <PresentationImageBlock className="presentation-img" src="/images/logo-cki.png" alt="Politechnika Śląska" loading="lazy" width="50" height="50" />
              <div>Centrum Kształcenia Inżynierów</div>
            </div>
            <div className="presentation-section-img-block">
              <PresentationImageBlock className="presentation-img" src="/images/logo-us.png" alt="Politechnika Śląska" loading="lazy" width="50" height="50" />
              <div>Uniwersytet śląski</div>
            </div>
            <div className="presentation-section-img-block">
              <PresentationImageBlock className="presentation-img" src="/images/wst-logo.png" alt="Wyższa szkoła techniczna" loading="lazy" width="50" height="50" />
      ...
      <PresentationBlock isDarkTheme={isDarkTheme} centered>
        <div>
          ...
          <PresentationSection>
            ...
            <div className="presentation-section-img-block">
              <PresentationImageBlock src="/images/eTwinning.png" alt="eTwinning" loading="lazy" width="50" height="50" />
              <div>eTwinning</div>
            </div>
            <div className="presentation-section-img-block">
              <PresentationImageBlock src="/images/erasmus.jpg" alt="Erasmus +" loading="lazy" width="50" height="50" />
              <div>Erasmus +</div>
            </div>
            <div className="presentation-section-img-block">
              <PresentationImageBlock src="/images/logo-zsb-project.png" alt="Konkurencyjność uczniów ZSB w Rybniku na rynku pracy" loading="lazy" width="50" height="50" />
      ...
      <PresentationBlock isDarkTheme={isDarkTheme} centered>
        <div>
          ...
          <PresentationSection>
            ...
            <div className="presentation-section-img-block">
              <a href="http://zsb.bip.edukacja.rybnik.eu/" rel="noopener noreferrer" title="Biuletyn Informacji Publicznej"><PresentationImageBlock src="/images/bip.png" alt="Biuletyn Informacji Publicznej" loading="lazy" width="50" height="50" /></a>
            </div>
          </PresentationSection>
        </div>
      </PresentationBlock>
      <PresentationBlock isDarkTheme={isDarkTheme} centered>
        <div>
          ...
          <PresentationSection>
            ...
            <div className="presentation-section-img-block">
              <a href="https://www.facebook.com/pages/category/Community/Rybnicka-Platforma-Poradnictwa-Zawodowego-187220987983602" rel="noopener noreferrer" title="Rybnicka Platofrma Poradnictwa Zawodowego"><PresentationImageBlock src="/images/rbkjobplatform.jpg" alt="Rybnicka Platofrma Poradnictwa Zawodowego" loading="lazy" width="50" height="50" /></a>
            </div>
          </PresentationSection>
        </div>
      </PresentationBlock>
