      ...
      <PresentationBlock isDarkTheme={isDarkTheme} centered>
        <div>
          ...
          <PresentationSection>
            ...
            <PresentationImageSection>
              <PresentationImageBlock src="/images/logo-cki.png" alt="Politechnika Śląska" loading="lazy" width="50" height="50" />
              <div>Centrum Kształcenia Inżynierów</div>
            </PresentationImageSection>
            <PresentationImageSection>
              <PresentationImageBlock src="/images/logo-us.png" alt="Politechnika Śląska" loading="lazy" width="50" height="50" />
              <div>Uniwersytet śląski</div>
            </PresentationImageSection>
            <PresentationImageSection>
              <PresentationImageBlock src="/images/wst-logo.png" alt="Wyższa szkoła techniczna" loading="lazy" width="50" height="50" />
